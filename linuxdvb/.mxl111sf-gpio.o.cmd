cmd_drivers/media/usb/dvb-usb-v2/mxl111sf-gpio.o := clang -Wp,-MMD,drivers/media/usb/dvb-usb-v2/.mxl111sf-gpio.o.d -nostdinc -isystem /home/bug/CoreELEC/build.CoreELEC-Amlogic-no.aarch64-22/toolchain/lib/clang/lib/clang/17/include -I./arch/arm64/include -I./arch/arm64/include/generated  -I./include -I./arch/arm64/include/uapi -I./arch/arm64/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/compiler-version.h -include ./include/linux/kconfig.h -I./common_drivers/include -I./common_drivers/include/uapi -include ./include/linux/compiler_types.h -D__KERNEL__ --target=aarch64-libreelec-linux-gnu -fintegrated-as -Werror=unknown-warning-option -Werror=ignored-optimization-argument -mlittle-endian -DCC_USING_PATCHABLE_FUNCTION_ENTRY -DKASAN_SHADOW_SCALE_SHIFT= -Qunused-arguments -fmacro-prefix-map=./= -Wno-format -Wno-unused-function -Wno-misleading-indentation -Wall -Wundef -Werror=strict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -Werror=implicit-function-declaration -Werror=implicit-int -Werror=return-type -Wno-format-security -std=gnu89 -Wno-tautological-compare -Wno-tautological-pointer-compare -Wno-error=address -Wno-return-type -mgeneral-regs-only -DCONFIG_CC_HAS_K_CONSTRAINT=1 -Wno-psabi -fno-asynchronous-unwind-tables -fno-unwind-tables -mbranch-protection=pac-ret+leaf -Wa,-march=armv8.5-a -DARM64_ASM_ARCH='"armv8.5-a"' -ffixed-x18 -DKASAN_SHADOW_SCALE_SHIFT= -fno-delete-null-pointer-checks -Wno-frame-address -Wno-address-of-packed-member -O2 -Wframe-larger-than=2048 -Wno-gnu -mno-global-merge -Wno-unused-but-set-variable -Wno-unused-const-variable -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-stack-clash-protection -g -fpatchable-function-entry=2 -fsanitize=shadow-call-stack -Wdeclaration-after-statement -Wvla -Wno-pointer-sign -Wno-array-bounds -fno-strict-overflow -fno-stack-check -Werror=date-time -fno-builtin-wcslen -Wno-initializer-overrides -Wno-format -Wno-sign-compare -Wno-format-zero-length -Wno-pointer-to-enum-cast -Wno-tautological-constant-out-of-range-compare -Wno-unaligned-access -Wno-cast-function-type-strict -Wno-enum-compare-conditional -mstack-protector-guard=sysreg -mstack-protector-guard-reg=sp_el0 -mstack-protector-guard-offset=1472 -I./drivers/media/dvb-frontends -I./drivers/media/tuners -I./drivers/media/common   -DMODULE  -DKBUILD_BASENAME='"mxl111sf_gpio"' -DKBUILD_MODNAME='"dvb_usb_mxl111sf"' -D__KBUILD_MODNAME=kmod_dvb_usb_mxl111sf -c -o drivers/media/usb/dvb-usb-v2/mxl111sf-gpio.o drivers/media/usb/dvb-usb-v2/mxl111sf-gpio.c
...
deps_drivers/media/usb/dvb-usb-v2/mxl111sf-gpio.o := \
  ...
  arch/arm64/include/asm/android_erratum_pgtable.h \
  ...
  include/media/rc-map.h \
    ...
    $(wildcard include/config/IR_IRMP_DECODER) \
  ...
  include/media/dvb_frontend.h \
    $(wildcard include/config/AMLOGIC_DVB_COMPAT) \
  ...
  include/linux/netdevice.h \
    ...
    $(wildcard include/config/AMLOGIC_ZAPPER_NET_CUT) \
